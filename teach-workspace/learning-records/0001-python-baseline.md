...
**Status:** provisional — re-sit the diagnostic in lesson `0001` at week 0 and update this record if
the score changes.

The Phase-0 diagnostic (lesson `0001-python-essentials-primer`) was taken cold during the scaffold:
...
**Evidence:** diagnostic `section.quiz` results for lesson 0001; missed items were #5 (dicts) and #6
(comprehensions).
